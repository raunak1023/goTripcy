...
<head>
    ...
    <!-- Custom Style -->
    <link id="main-style" rel="stylesheet" href="resources/css/Dashboard.css">
...
<body onload="onLoad();">
    ...
    <div id="page-wrapper">
                ...
                <div class="container">
                    <h1 class="logo navbar-brand">
                        <a href="index.html" title="Travelo - home">
                            <img src="resources/images/logo.png" alt="Travelo HTML5 Template" />
                        </a>
                    </h1>
                    ...
                    <nav id="main-menu" role="navigation">
                        <ul class="menu">
                            ...
                            <li class="menu-item-has-children">
                                <a href="hotel-index.html">Holiday Packages</a>
                                <ul>
                            ...
                            <li class="menu-item-has-children">
                                <a href="flight-index.html">India Tour</a>
                                <ul>
                            ...
                            <li class="menu-item-has-children">
                                <a href="car-index.html">International  Tour</a>
                                <ul>
                            ...
                            <li class="menu-item-has-children displayNone">
                            ...
                            <li class="menu-item-has-children">
                                <a href="tour-index.html">Hot Offer</a>
                                <ul>
        ...
        <div class="search-box-wrapper">
                <div class="search-box container">
                    <ul class="search-tabs clearfix displayNone">
        ...
        <section id="content">
            ...
            <div class="section container">
                ...
                <div class="row image-box style3">
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        <article class="box">
                            <img id="pkg_in_img_1" class="pak_img" width="270" height="160" alt="" src=""/>
                            <div class="details">
                            	<span class="price">
                                    <small>Starting From</small>
                                    <label class="fa fa-inr" id="pkg_in_price_1"></label>
                                </span>
                                <h4 id="pkg_in_head_1" class="box-title"></h4>
                                <p class="offers-content displayNone">(15 deal offers)</p>
                                <div data-placement="bottom" data-toggle="tooltip" title="4 stars" class="five-stars-container displayNone">
                                    <span style="width: 80%;" class="five-stars displayNone"></span>
                                </div>
                                <p id="pkg_in_desc_1" class="description"></p>
                                <div class="action">
                                    <a href="hotel-detailed.html" class="button btn-small">SELECT</a>
                                    <a href="#" class="button btn-small yellow popup-map" data-box="48.856614, 2.352222">VIEW ON MAP</a>
                                </div>
                    ...
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        <article class="box">
                            <img id="pkg_in_img_2" class="pak_img" width="270" height="160" alt="" src=""/>
                            <div class="details">
                            	<span class="price">
                                    <small>Starting From</small>
                                    <label class="fa fa-inr" id="pkg_in_price_2"></label>
                                </span>
                                <h4 id="pkg_in_head_2" class="box-title"></h4>
                                <p class="offers-content displayNone">(15 deal offers)</p>
                                <div data-placement="bottom" data-toggle="tooltip" title="4 stars" class="five-stars-container displayNone">
                                    <span style="width: 80%;" class="five-stars displayNone"></span>
                                </div>
                                <p id="pkg_in_desc_2" class="description"></p>
                                <div class="action">
                                    <a href="hotel-detailed.html" class="button btn-small">SELECT</a>
                                    <a href="#" class="button btn-small yellow popup-map" data-box="48.856614, 2.352222">VIEW ON MAP</a>
                                </div>
                    ...
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        <article class="box">
                            <img id="pkg_in_img_3" class="pak_img" width="270" height="160" alt="" src=""/>
                            <div class="details">
                            	<span class="price">
                                    <small>Starting From</small>
                                    <label class="fa fa-inr" id="pkg_in_price_3"></label>
                                </span>
                                <h4 id="pkg_in_head_3" class="box-title"></h4>
                                <p class="offers-content displayNone">(15 deal offers)</p>
                                <div data-placement="bottom" data-toggle="tooltip" title="4 stars" class="five-stars-container displayNone">
                                    <span style="width: 80%;" class="five-stars displayNone"></span>
                                </div>
                                <p id="pkg_in_desc_3" class="description"></p>
                                <div class="action">
                                    <a href="hotel-detailed.html" class="button btn-small">SELECT</a>
                                    <a href="#" class="button btn-small yellow popup-map" data-box="48.856614, 2.352222">VIEW ON MAP</a>
                                </div>
                    ...
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        <article class="box">
                            <img id="pkg_in_img_4" class="pak_img" width="270" height="160" alt="" src=""/>
                            <div class="details">
                            	<span class="price">
                                    <small>Starting From</small>
                                    <label class="fa fa-inr" id="pkg_in_price_4"></label>
                                </span>
                                <h4 id="pkg_in_head_4" class="box-title"></h4>
                                <p class="offers-content displayNone">(15 deal offers)</p>
                                <div data-placement="bottom" data-toggle="tooltip" title="4 stars" class="five-stars-container displayNone">
                                    <span style="width: 80%;" class="five-stars displayNone"></span>
                                </div>
                                <p id="pkg_in_desc_4" class="description"></p>
                                <div class="action">
                                    <a href="hotel-detailed.html" class="button btn-small">SELECT</a>
                                    <a href="#" class="button btn-small yellow popup-map" data-box="48.856614, 2.352222">VIEW ON MAP</a>
                                </div>
            ...
            <div class="sectionTrending container">
                <h2>Trending Pakages</h2>
                <div class="row image-box hotel listing-style1 style3">
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        <article class="box">
                            <img id="pkg_trend_img_1" class="pak_img" width="270" height="160" src="" alt=""/>
                            <div class="details">
                                <span class="price">
                                    <small>Starting From</small>
                                    <label class="fa fa-inr" id="pkg_trend_price_1"></label>
                                </span>
                                <h4 id="pkg_trend_head_1" class="box-title"></h4>
                                <div class="feedback displayNone">
                                    <div title="4 stars" class="five-stars-container displayNone" data-toggle="tooltip" data-placement="bottom"><span class="five-stars" style="width: 80%;"></span></div>
                                    <span class="review displayNone">270 reviews</span>
                                </div>
                                <p id="pkg_trend_desc_1" class="description"></p>
                                <div class="action">
                                    <a href="hotel-detailed.html" class="button btn-small">SELECT</a>
                                    <a href="#" class="button btn-small yellow popup-map" data-box="48.856614, 2.352222">VIEW ON MAP</a>
                                </div>
                    ...
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        <article class="box">
                            <img id="pkg_trend_img_2" class="pak_img" width="270" height="160" src="" alt=""/>
                            <div class="details">
                                <span class="price">
                                    <small>Starting From</small>
                                    <label class="fa fa-inr" id="pkg_trend_price_2"></label>
                                </span>
                                <h4 id="pkg_trend_head_2" class="box-title"></h4>
                                <div class="feedback displayNone">
                                    <div title="4 stars" class="five-stars-container displayNone" data-toggle="tooltip" data-placement="bottom"><span class="five-stars" style="width: 80%;"></span></div>
                                    <span class="review displayNone">170 reviews</span>
                                </div>
                                <p id="pkg_trend_desc_2" class="description"></p>
                                <div class="action">
                                    <a href="hotel-detailed.html" class="button btn-small">SELECT</a>
                                    <a href="#" class="button btn-small yellow popup-map" data-box="48.856614, 2.352222">VIEW ON MAP</a>
                                </div>
                    ...
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        <article class="box">
                            <img id="pkg_trend_img_3" class="pak_img" width="270" height="160" src="" alt=""/>
                            <div class="details">
                                <span class="price">
                                    <small>Starting From</small>
                                    <label class="fa fa-inr" id="pkg_trend_price_3"></label>
                                </span>
                                <h4 id="pkg_trend_head_3" class="box-title"></h4>
                                <div class="feedback displayNone">
                                    <div title="4 stars" class="five-stars-container displayNone" data-toggle="tooltip" data-placement="bottom"><span class="five-stars" style="width: 80%;"></span></div>
                                    <span class="review displayNone">170 reviews</span>
                                </div>
                                <p id="pkg_trend_desc_3" class="description"></p>
                                <div class="action">
                                    <a href="hotel-detailed.html" class="button btn-small">SELECT</a>
                                    <a href="#" class="button btn-small yellow popup-map" data-box="48.856614, 2.352222">VIEW ON MAP</a>
                                </div>
                    ...
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        <article class="box">
                            <img id="pkg_trend_img_4" class="pak_img" width="270" height="160" src="" alt=""/>
                            <div class="details">
                                <span class="price">
                                    <small>Starting From</small>
                                    <label class="fa fa-inr" id="pkg_trend_price_4"></label>
                                </span>
                                <h4 id="pkg_trend_head_4" class="box-title"></h4>
                                <div class="feedback displayNone">
                                    <div title="4 stars" class="five-stars-container displayNone" data-toggle="tooltip" data-placement="bottom"><span class="five-stars" style="width: 80%;"></span></div>
                                    <span class="review displayNone">170 reviews</span>
                                </div>
                                <p id="pkg_trend_desc_4" class="description"></p>
                                <div class="action">
                                    <a href="hotel-detailed.html" class="button btn-small">SELECT</a>
                                    <a href="#" class="button btn-small yellow popup-map" data-box="48.856614, 2.352222">VIEW ON MAP</a>
                                </div>
    ...
    <script type="text/javascript" src="resources/js/gmap3.min.js"></script>
